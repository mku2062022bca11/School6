        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl opacity-90 max-w-3xl mx-auto leading-relaxed">
              Step into the future of education with our state-of-the-art campus
              designed to inspire, innovate, and empower the next generation of
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Where technology meets education to create extraordinary learning
              experiences
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {smartFeatures.map((feature, index) => (
              ...
              >
                <div
                  className={`h-48 bg-gradient-to-r ${feature.color} relative`}
                >
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Explore our facilities with our interactive campus guide
            </p>
          </div>
              ...
              {facilities.map((facility, index) => (
                ...
                >
                  <div
                    className={`w-12 h-12 ${
                      theme.primaryBg
                    } rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-200 ${
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Every space designed to inspire learning and growth
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  State-of-the-art maker spaces with 3D printers, laser cutters,
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Interactive whiteboards, VR headsets, and AI-powered learning
                  analytics.
                </p>
                <div className="flex justify-between text-xs text-gray-500">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Advanced video conferencing for international collaborations
                  and guest lectures.
                </p>
                <div className="flex justify-between text-xs text-gray-500">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Advanced systems ensuring a secure learning environment
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {safetyFeatures.map((feature, index) => (
              ...
              >
                <div
                  className={`w-16 h-16 ${theme.primaryBg} rounded-2xl flex items-center justify-center mb-4 mx-auto`}
                >
                  <feature.icon className="h-8 w-8 text-white" />
                </div>
                ...
                <div
                  className={`text-xs font-semibold ${theme.primary} px-3 py-1 ${theme.primaryLight} rounded-full`}
                >
                  {feature.stats}
                </div>
              </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Safe, eco-friendly, and convenient transportation options
            </p>
          </div>
          ...
          <div className="mt-12 bg-white p-8 rounded-2xl shadow-lg">
            <h3 className="text-2xl font-bold text-gray-900 mb-4 text-center">
              Additional Transportation Features
            </h3>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                <div
                  className={`w-12 h-12 ${theme.primaryBg} rounded-xl flex items-center justify-center mb-3 mx-auto`}
                >
                ...
                <p className="text-sm text-gray-600">
                  Parents can track bus location and estimated arrival times in
                  real-time
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Trained staff, emergency procedures, and safety equipment on
                  all vehicles
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Electric and hybrid vehicles reducing our carbon footprint by
                  80%
                </p>
              </div>
            </div>
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
            Take a virtual tour of our innovative facilities or schedule an
            in-person visit to see the future of education firsthand.
          </p>
